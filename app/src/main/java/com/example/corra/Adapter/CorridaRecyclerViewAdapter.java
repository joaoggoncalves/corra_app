...
public class CorridaRecyclerViewAdapter extends RecyclerView.Adapter<CorridaRecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.distTv.setText(String.format(Locale.getDefault(), "%.2f Km", (mList.get(position).getVelocidade()*(Duration.ofMillis(mList.get(position).getTempo()).getSeconds()/3600.0))));
